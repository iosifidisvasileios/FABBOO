 ...
 */
public class FABBOO_Template_for_T_Exp {
    private int saIndex;
    ...
    private double class_lamda = 0.9;
    ...
    private CircularFifoQueue<Double> buf_predictions = new CircularFifoQueue<Double>(5000);


    private  ArrayList<Double> bacc_stream = new ArrayList<Double>();
    private  ArrayList<Double> Gmean = new ArrayList<Double>();
    private  ArrayList<Double> F1Score = new ArrayList<Double>();
    private  ArrayList<Double> Accuracy = new ArrayList<Double>();
    private  ArrayList<Double> Kappa = new ArrayList<Double>();
    private  ArrayList<Double> StParity = new ArrayList<Double>();
    private  ArrayList<Double> Thresholds = new ArrayList<Double>();
    private  ArrayList<Double> EQOP = new ArrayList<Double>();
    private  ArrayList<Double> PredPar = new ArrayList<Double>();
    private  ArrayList<Double> time = new ArrayList<Double>();
    private  ArrayList<Double> BACC = new ArrayList<Double>();
    private  ArrayList<Double> Recall = new ArrayList<Double>();

    private final static Logger logger = Logger.getLogger(FABBOO_Template_for_T_Exp.class.getName());


    public FABBOO_Template_for_T_Exp(int weakL, int saIndex, int indexOfDenied, int indexOfGranted, int indexOfDeprived, String OPT) {
        this.weakL = weakL;
    ...
    public FABBOO_Template_for_T_Exp(int weakL, double lambda, int window, int saIndex, int indexOfDenied, int indexOfGranted, int indexOfDeprived, String OPT) {
    ...
    public FABBOO_Template_for_T_Exp(int weakL, double lambda, int saIndex, int indexOfDenied, int indexOfGranted, int indexOfDeprived, String OPT) {
        this.weakL = weakL;
        setClass_lamda(lambda);
        this.saIndex = saIndex;
        this.indexOfGranted = indexOfGranted;
...
*/
            ...
            bacc_stream.add(evaluator.getBACC());
        }
        if (OPT.equals("SP")) {
            StParity.add(delayed_discrimination);
            logger.info("discrimination = " +  Arrays.toString(StParity.toArray()));
        }

        if (OPT.equals("EQOP")) {
            EQOP.add(equal_opportunity(tp_protected, fn_protected, tp_non_protected, fn_non_protected));
            logger.info("discrimination = " + Arrays.toString(EQOP.toArray()));
        }
        ...
        logger.info("Balanced Accuracy = "  + Arrays.toString(BACC.toArray()));
