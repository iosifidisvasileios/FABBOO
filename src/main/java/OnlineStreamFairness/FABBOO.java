 ...
 * @version $Revision: 7 $
 */
public class FABBOO extends AbstractClassifier implements MultiClassClassifier {

    public double threshold = 0.5;

    private int indexOfTargetClass; // sensitive attribute: female
    private int indexOfnonTargetClass; // sensitive attribute: female
    ...
    public FABBOO(int indexOfDeprived, int saIndex, int targetClass, int nonTargetClass, String OPT) {
        this.indexOfDeprived = indexOfDeprived;
        this.saIndex = saIndex;
        this.OPT = OPT;
        this.indexOfTargetClass = targetClass;
        this.indexOfnonTargetClass = nonTargetClass;
    }
...
//            }
    ...
    public double[] getVotesForInstanceReverse(Instance inst) {
        ...
        double targetConf;
        try {
            targetConf = combinedVote.getArrayCopy()[indexOfnonTargetClass];
        } catch (Exception e) {
            targetConf = -1;
    ...
    public double tweak_boundary(CircularFifoQueue<Double> buffer, int sdb) {
    ...
    public double tweak_boundary_reverse(CircularFifoQueue<Double> buffer, int sdb) {
