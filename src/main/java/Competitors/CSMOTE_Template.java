...
public class CSMOTE_Template {
    ...
    private final static Logger logger = Logger.getLogger(CSMOTE_Template.class.getName());


    public CSMOTE_Template(int weakL , int saIndex, int indexOfDenied, int indexOfGranted, int indexOfDeprived, String OPT) {
        this.weakL= weakL;
    ...
    public void deploy(Instances buffer) throws Exception {
        ...
        cSMOTE.setModelContext(new InstancesHeader(buffer));
    ...
    public ArrayList<Double> getPredPar() { return PredPar; }
}
